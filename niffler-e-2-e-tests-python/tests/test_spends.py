...
class TestSpends:
    ...
    def test_add_spend(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.spending_section).to_contain_text(f'{amount}')
        LoggedExpect(app.main_page.spending_section).to_contain_text(f'{category_name}')
    ...
    def test_type_part_of_category_name(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.get_category_in_list_by_name(category_name)).to_be_visible()

    @Actions.login
    def test_category_non_exists(self, app, generator):
        app.main_page.type_category(generator.word())
        LoggedExpect(app.main_page.category_selector_without_coincidence).to_be_visible()

    @Actions.login
    def test_empty_category(self, app, login, generator):
        app.main_page.set_amount(str(generator.amount())).add_new_spend()

        LoggedExpect(app.main_page.error_message).to_contain_text("Category is required")
    ...
    def test_negative_amount(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.error_message).to_contain_text("Amount should be greater than 0")
    ...
    def test_empty_amount(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.error_message).to_contain_text("Amount is required")
    ...
    def test_empty_spend_date(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.error_message).to_contain_text("Spend date is required")
    ...
    def test_future_spend_date(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.error_message).to_contain_text("You can not pick future date")
    ...
    def test_add_with_description_longer_then_256(self, app, generator, get_any_category):
        ...
        LoggedExpect(app.main_page.spending_section).to_contain_text(f'{description[:255]}')
