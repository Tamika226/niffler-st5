...
def test_category_non_exists(main_page: MainPage, profile_page: ProfilePage, login, generator):
...
def test_empty_category(main_page: MainPage, profile_page: ProfilePage, login, generator):
...
def test_negative_amount(main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
...
def test_empty_amount(main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
