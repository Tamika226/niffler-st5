...
def test_add_spend(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
...
def test_category_non_exists(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator):
...
def test_empty_category(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator):
...
def test_negative_amount(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
...
def test_empty_amount(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
...
def test_empty_spend_date(page: Page, main_page: MainPage, profile_page: ProfilePage, login, generator, get_any_category):
